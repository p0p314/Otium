import { BarChart3, Clapperboard, Home, ListVideo, Search, type LucideIcon } from "lucide-react";

/** Chemins de premier niveau connus du routeur (typage des liens TanStack Router). */
export type AppPath = "/" | "/search" | "/library" | "/lists" | "/stats";
...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  { to: "/lists", label: "Mes listes", short: "Listes", icon: ListVideo, auth: true },
  { to: "/stats", label: "Statistiques", short: "Stats", icon: BarChart3, auth: true },
];
